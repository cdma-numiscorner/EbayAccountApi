...
class OnboardingApi
{
     ...
     *
     * @param  string $marketplace_id The eBay marketplace ID associated with the onboarding status to retrieve. Only enums for marketplaces that support or will soon support eBay managed payments are allowed. Error 20408 is returned for any other eBay marketplace. No response payload is returned with this error. (required)
     * @param  string $payments_program_type The type of payments program whose status is returned by the call. Presently, the only supported payments program is EBAY_PAYMENTS. For details on the program, see Payments Terms of Use. (required)
     *
     * @throws \OpenAPI\EbayAccountClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\EbayAccountClient\Model\PaymentsProgramOnboardingResponse
     */
    public function getPaymentsProgramOnboarding($marketplace_id, $payments_program_type)
    {
        list($response) = $this->getPaymentsProgramOnboardingWithHttpInfo($marketplace_id, $payments_program_type);
        return $response;
    }
     ...
     * @throws \OpenAPI\EbayAccountClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\EbayAccountClient\Model\PaymentsProgramOnboardingResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPaymentsProgramOnboardingWithHttpInfo($marketplace_id, $payments_program_type)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\EbayAccountClient\Model\PaymentsProgramOnboardingResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\EbayAccountClient\Model\PaymentsProgramOnboardingResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\EbayAccountClient\Model\PaymentsProgramOnboardingResponse';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\EbayAccountClient\Model\PaymentsProgramOnboardingResponse',
    ...
    public function getPaymentsProgramOnboardingRequest($marketplace_id, $payments_program_type)
    {
        ...
        if ($marketplace_id === null || (is_array($marketplace_id) && count($marketplace_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $marketplace_id when calling getPaymentsProgramOnboarding'
            );
        }
        ...
        if ($payments_program_type === null || (is_array($payments_program_type) && count($payments_program_type) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $payments_program_type when calling getPaymentsProgramOnboarding'
            );
        }
