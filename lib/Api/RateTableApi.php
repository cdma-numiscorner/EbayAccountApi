...
class RateTableApi
{
     ...
     * @return \OpenAPI\EbayAccountClient\Model\RateTableResponse
     */
     ...
     * @throws \OpenAPI\EbayAccountClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\EbayAccountClient\Model\RateTableResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getRateTablesWithHttpInfo($country_code = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\EbayAccountClient\Model\RateTableResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\EbayAccountClient\Model\RateTableResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\EbayAccountClient\Model\RateTableResponse';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\EbayAccountClient\Model\RateTableResponse',
