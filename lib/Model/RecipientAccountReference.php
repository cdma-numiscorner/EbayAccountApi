...
class RecipientAccountReference implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets reference_id
     *
     * @param string|null $reference_id Contains the PayPal email address of the recipient (buyer) if referenceType is set to PAYPAL_EMAIL.
     *
     * @return self
     */
     ...
     * Sets reference_type
     *
     * @param string|null $reference_type A reference a recipient's account. Currently only PAYPAL_EMAIL is valid. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/account/types/api:RecipientAccountReferenceTypeEnum'>eBay API documentation</a>
     *
     * @return self
     */
