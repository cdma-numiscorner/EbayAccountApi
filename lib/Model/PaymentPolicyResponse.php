 ...
 */
class PaymentPolicyResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentPolicyResponse';
    ...
    protected static $openAPITypes = [
        ...
        'prev' => 'string',
        'total' => 'int',
        'payment_policies' => '\OpenAPI\EbayAccountClient\Model\PaymentPolicy[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['payment_policies'] = $data['payment_policies'] ?? null;
    }
     ...
     * Sets offset
     *
     * @param int|null $offset The number of results skipped in the result set before listing the first returned result. Note: The items in a paginated result set use a zero-based list where the first item in the list has an offset of 0.
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\EbayAccountClient\Model\PaymentPolicy[]|null
     */
     ...
     *
     * @param \OpenAPI\EbayAccountClient\Model\PaymentPolicy[]|null $payment_policies A list of the seller's payment policies.
     *
     * @return self
     */
