...
class ShippingService implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'additional_shipping_cost' => '\OpenAPI\EbayAccountClient\Model\Amount',
        'buyer_responsible_for_pickup' => 'bool',
        'buyer_responsible_for_shipping' => 'bool',
        'cash_on_delivery_fee' => '\OpenAPI\EbayAccountClient\Model\Amount',
        'free_shipping' => 'bool',
        'shipping_carrier_code' => 'string',
        'shipping_cost' => '\OpenAPI\EbayAccountClient\Model\Amount',
        'shipping_service_code' => 'string',
        'ship_to_locations' => '\OpenAPI\EbayAccountClient\Model\RegionSet',
        'sort_order' => 'int',
        'surcharge' => '\OpenAPI\EbayAccountClient\Model\Amount'
    ];
     ...
     *
     * @param \OpenAPI\EbayAccountClient\Model\Amount|null $additional_shipping_cost additional_shipping_cost
     *
     * @return self
     */
     ...
     *
     * @param \OpenAPI\EbayAccountClient\Model\Amount|null $cash_on_delivery_fee cash_on_delivery_fee
     *
     * @return self
     */
     ...
     * Sets free_shipping
     *
     * @param bool|null $free_shipping If set to true, the seller offers free shipping to the buyer. This field can only be included and set to 'true' for the first domestic shipping service option specified in the shippingServices container (it is ignored if set for subsequent shipping services). The first specified shipping service option has a sortOrder value of 1 or (if the sortOrderId field is not used) it is the shipping service option that's specified first in the shippingServices container.
     *
     * @return self
     */
     ...
     *
     * @param string|null $shipping_carrier_code The shipping carrier, such as 'USPS', 'FedEx', 'UPS', and so on.
     *
     * @return self
     */
     ...
     * Sets shipping_cost
     *
     * @param \OpenAPI\EbayAccountClient\Model\Amount|null $shipping_cost shipping_cost
     *
     * @return self
     */
     ...
     *
     * @param string|null $shipping_service_code The shipping service that the shipping carrier uses to ship an item. For example, an overnight, two-day delivery, or other type of service. For details on configuring shipping services, see Setting the shipping carrier and shipping service values.
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\EbayAccountClient\Model\RegionSet|null
     */
     ...
     *
     * @param \OpenAPI\EbayAccountClient\Model\RegionSet|null $ship_to_locations ship_to_locations
     *
     * @return self
     */
     ...
     * Sets surcharge
     *
     * @param \OpenAPI\EbayAccountClient\Model\Amount|null $surcharge surcharge
     *
     * @return self
     */
