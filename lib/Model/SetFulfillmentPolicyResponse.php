...
class SetFulfillmentPolicyResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets warnings
     *
     * @param \OpenAPI\EbayAccountClient\Model\Error[]|null $warnings A list of warnings that were generated during the processing of the request. This field normally returns empty, which indicates the request did not generate any warnings.
     *
     * @return self
     */
