...
class Deposit implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'amount' => '\OpenAPI\EbayAccountClient\Model\Amount',
        'due_in' => '\OpenAPI\EbayAccountClient\Model\TimeDuration',
     ...
     * Sets amount
     *
     * @param \OpenAPI\EbayAccountClient\Model\Amount|null $amount amount
     *
     * @return self
     */
     ...
     * Sets due_in
     *
     * @param \OpenAPI\EbayAccountClient\Model\TimeDuration|null $due_in due_in
     *
     * @return self
     */
     ...
     *
     * @param \OpenAPI\EbayAccountClient\Model\PaymentMethod[]|null $payment_methods For deposits (which are applicable to only motor listings), the paymentMethodType must be set to 'PAYPAL' and you must also populate the fields in the recipientAccountReference object. Required if your motor vehicles listing requires a deposit.
     *
     * @return self
     */
