...
namespace OpenAPI\EbayAccountClient;
...
class Configuration
{
    ...
    {
        $report  = 'PHP SDK (OpenAPI\EbayAccountClient) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: v1.6.0' . PHP_EOL;
