# OpenAPI\EbayAccountClient\FulfillmentPolicyApi
...
```php
createFulfillmentPolicy($fulfillment_policy_request): \OpenAPI\EbayAccountClient\Model\SetFulfillmentPolicyResponse
```
...
------------- | ------------- | ------------- | -------------
 **fulfillment_policy_request** | [**\OpenAPI\EbayAccountClient\Model\FulfillmentPolicyRequest**](../Model/FulfillmentPolicyRequest.md)| Request to create a seller account fulfillment policy. |

### Return type

[**\OpenAPI\EbayAccountClient\Model\SetFulfillmentPolicyResponse**](../Model/SetFulfillmentPolicyResponse.md)
...
```php
getFulfillmentPolicies($marketplace_id): \OpenAPI\EbayAccountClient\Model\FulfillmentPolicyResponse
```
...
[**\OpenAPI\EbayAccountClient\Model\FulfillmentPolicyResponse**](../Model/FulfillmentPolicyResponse.md)
...
```php
getFulfillmentPolicy($fulfillment_policy_id): \OpenAPI\EbayAccountClient\Model\FulfillmentPolicy
```
...
[**\OpenAPI\EbayAccountClient\Model\FulfillmentPolicy**](../Model/FulfillmentPolicy.md)
...
```php
getFulfillmentPolicyByName($marketplace_id, $name): \OpenAPI\EbayAccountClient\Model\FulfillmentPolicy
```
...
```php
updateFulfillmentPolicy($fulfillment_policy_id, $fulfillment_policy_request): \OpenAPI\EbayAccountClient\Model\SetFulfillmentPolicyResponse
```
...
$fulfillment_policy_request = new \OpenAPI\EbayAccountClient\Model\FulfillmentPolicyRequest(); // \OpenAPI\EbayAccountClient\Model\FulfillmentPolicyRequest | Fulfillment policy request
 ...
 **fulfillment_policy_request** | [**\OpenAPI\EbayAccountClient\Model\FulfillmentPolicyRequest**](../Model/FulfillmentPolicyRequest.md)| Fulfillment policy request |
