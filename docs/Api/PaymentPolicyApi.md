# OpenAPI\EbayAccountClient\PaymentPolicyApi
...
```php
createPaymentPolicy($payment_policy_request): \OpenAPI\EbayAccountClient\Model\SetPaymentPolicyResponse
```
...
$apiInstance = new OpenAPI\EbayAccountClient\Api\PaymentPolicyApi(
    // If you want use custom http client, pass your client which implements `GuzzleHttp\ClientInterface`.
    // This is optional, `GuzzleHttp\Client` will be used as default.
    new GuzzleHttp\Client(),
    $config
);
$payment_policy_request = new \OpenAPI\EbayAccountClient\Model\PaymentPolicyRequest(); // \OpenAPI\EbayAccountClient\Model\PaymentPolicyRequest | Payment policy request
...
------------- | ------------- | ------------- | -------------
 **payment_policy_request** | [**\OpenAPI\EbayAccountClient\Model\PaymentPolicyRequest**](../Model/PaymentPolicyRequest.md)| Payment policy request |

### Return type

[**\OpenAPI\EbayAccountClient\Model\SetPaymentPolicyResponse**](../Model/SetPaymentPolicyResponse.md)
...
```php
getPaymentPolicies($marketplace_id): \OpenAPI\EbayAccountClient\Model\PaymentPolicyResponse
```
...
[**\OpenAPI\EbayAccountClient\Model\PaymentPolicyResponse**](../Model/PaymentPolicyResponse.md)
...
```php
getPaymentPolicy($payment_policy_id): \OpenAPI\EbayAccountClient\Model\PaymentPolicy
```
...
[**\OpenAPI\EbayAccountClient\Model\PaymentPolicy**](../Model/PaymentPolicy.md)
...
```php
getPaymentPolicyByName($marketplace_id, $name): \OpenAPI\EbayAccountClient\Model\PaymentPolicy
```
...
```php
updatePaymentPolicy($payment_policy_id, $payment_policy_request): \OpenAPI\EbayAccountClient\Model\SetPaymentPolicyResponse
```
